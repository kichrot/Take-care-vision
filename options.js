...
function load_data() {
    chrome.storage.local.get(['list_domain', 'def_text_param', 'interface_param', 'font_param'], function(result) {
        ...
        display_options("def_text_size", size_font_def.toFixed(2));
        display_options("def_h1", title_coeff_h1.toFixed(1));
        display_options("def_h2", title_coeff_h2.toFixed(1));
        display_options("def_h3", title_coeff_h3.toFixed(1));
        display_options("def_h4", title_coeff_h4.toFixed(1));
        display_options("def_h5", title_coeff_h5.toFixed(1));
        display_options("def_h6", title_coeff_h6.toFixed(1));
        display_options("line_height", line_height.toFixed(1));
        ...
        display_options("font_shadow_width", shadow_font_width.toFixed(1));
        shadow_font_blur = Number(arr[3]);
        display_options("font_shadow_blur", shadow_font_blur.toFixed(1));
        shadow_font_lightens = Number(arr[4]);
        display_options("font_shadow_lightens", shadow_font_lightens.toFixed(1));
        ...
        display_options("font_contour_width", contour_font_width.toFixed(1));
