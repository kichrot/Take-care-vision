...
var domain_list;
var text_param_start = "1.5;1.3;1.1;1;0.9;0.7;1.1;0;0;1;0;0;100;";
var text_param_def;
...
function Save() {
    if (confirm("Attention! \nYour individual settings, for specific domains, will be reset to the default new settings. \nYou agree?")) {
        ...
        var tpd = size_font_def + ";" + title_coeff_h1 + ";" + title_coeff_h2 + ";" + title_coeff_h3 + ";" + title_coeff_h4 + ";" + title_coeff_h5 + ";" + title_coeff_h6 + ";" + line_height + ";" + line_height_on_off + ";" + text_param_on_off + ";" + page_css_zoom + ";" + page_X_shift + ";" + page_Y_shift + ";" + page_width + ";";
